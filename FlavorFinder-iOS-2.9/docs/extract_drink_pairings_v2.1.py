                ...
                if 'cocktail' in drink_normalized:
                    ...
                    if made_with_match:
                        ...
                        for spirit_name in spirit_names:
                            ...
                            # Prioritize base spirits over liqueurs
                            matched = False
                            for spirit_type, spirit_style in SPIRIT_STYLES.items():
                                # Skip liqueurs in favor of base spirits (bourbon > cointreau)
                                if spirit_style == 'liqueur':
                                    continue
                                if spirit_type in spirit_name:
