...
(URL: ask Matt — record it here when known). No analytics or user testing exists yet.
...
1. Record the Vercel URL here and in CLAUDE.md; confirm auto-deploy from GitHub main.
